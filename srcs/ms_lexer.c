...
{
	//fun_count_special_chars(lexer, command);
	...
	while (temp != NULL)
	{
		printf("Current content add: %p\n", &lexer->dictionary->content);
		printf("Next content add: %p\n", lexer->dictionary->next);
		printf("Current content: %s\n", lexer->dictionary->content->string);
		printf("Current len: %d\n", lexer->dictionary->content->len);
		printf("Current tok type: %s\n", lexer->dictionary->content->token);
		temp = lexer->dictionary->next;
	}
